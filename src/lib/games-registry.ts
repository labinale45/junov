...
export const GAMES: GameDef[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "minesweeper unblocked at school",
      "free minesweeper online",
      "play minesweeper browser",
    ],
    faqs: [
      { question: "Is this Minesweeper unblocked at school?", answer: "This is a normal public web page with no login, install, or plugin required — if your school or work network allows this site, the game just works, including on shared or restricted devices." },
      { question: "How do you play Minesweeper?", answer: "Click any tile to reveal it. Revealed tiles show a number telling you how many mines are hiding among the up to 8 surrounding tiles — use that to logically deduce which nearby tiles are safe. Clear every tile that isn't a mine to win." },
      { question: "What do the numbers mean in Minesweeper?", answer: "Each number shows exactly how many mines are hidden in the up to 8 tiles touching it (including diagonals). A blank revealed tile means zero mines are adjacent." },
      { question: "Is this Minesweeper free?", answer: "Yes, completely free with no login, no signup, and no limit on how many games you play." },
      { question: "Do I need to download anything?", answer: "No, it runs entirely in your browser — nothing to install on desktop or mobile." },
      ...
      { question: "What is the difference between Beginner and Intermediate?", answer: "Beginner is a 9x9 board with 10 mines, a quick round for warming up. Intermediate steps up to a 16x16 board with 40 mines for a longer, harder game. Pick either from the settings menu." },
      { question: "Can I play on my phone?", answer: "Yes, the board is fully touch-friendly — tap to reveal a tile and use Flag mode from the settings menu to place flags without right-clicking." },
      { question: "How do I get better at Minesweeper?", answer: "Start every game from a corner or edge to open up more of the board, always flag mines you're certain about before revealing more tiles, and use the number-vs-flag-count trick: if a number's flagged neighbors already equal the number, every other neighbor is safe to click." },
      { question: "What is the fastest Minesweeper time ever?", answer: "On the classic Beginner (9x9, 10 mines) board, top competitive players have cleared it in well under 5 seconds; the official record recognized by the speedrunning community sits around 0.49 seconds using an optimized clicking technique, though casual play typically takes 30 seconds to a few minutes." },
