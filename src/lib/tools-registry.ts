...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    description: "Compress a picture or photo online for free — JPG, PNG, WebP and AVIF. Reduce image file size without losing quality. No upload, runs in your browser instantly.",
    category: "image",
    categoryLabel: "Image Tools",
    icon: Layers,
    accent: "emerald",
    keywords: ["image compressor", "compress image online", "reduce image size", "jpg compressor", "png compressor free", "compress a image", "compress picture", "compression picture", "compression photo", "photo compressor online", "less than 1mb converter", "compress image to 1mb", "image size reducer 1mb", "compress photo to 1mb free"],
    faqs: [
      { question: "How do I compress a picture without losing quality?", answer: "Upload your photo and use the quality slider — most pictures compress 40-80% smaller with no visible quality loss. Compare the before/after with the built-in slider before downloading." },
      ...
      { question: "Is my image uploaded to a server?", answer: "No. Compression happens entirely in your browser using the Canvas API." },
      { question: "Can I compress an image to a specific size like 1MB?", answer: "Yes, switch to \"By Target Size\" mode, enter a size like 1MB, and the tool automatically finds the highest quality that still fits under that limit." },
      { question: "Is it free to use?", answer: "Yes, completely free with no signup, no watermark, and no daily limit." },
    ],
  ...
  },
  {
    ...
    description: "Resize image files online for free by pixels or percentage — resize one image or many. Maintain aspect ratio automatically. No upload, works in your browser.",
    category: "image",
    categoryLabel: "Image Tools",
    icon: Square,
    accent: "sky",
    keywords: ["image resizer", "resize image online free", "change image size", "resize jpg png online", "image resize", "resize image", "resize images", "resizer image"],
    faqs: [
      { question: "Can I resize multiple images at once?", answer: "This tool resizes one image at a time with instant pixel-perfect control and a live preview." },
  ...
  },
  {
    ...
    description: "Free online photo editor — bring any photo to the editor and adjust brightness, contrast, saturation, hue, sharpness and blur. Instant preview, no upload needed.",
    category: "image",
    categoryLabel: "Image Tools",
    icon: SlidersHorizontal,
    accent: "rose",
    keywords: ["image editor online free", "adjust brightness contrast", "image saturation tool", "online photo editor", "photo to editor", "free photo editor online", "edit photo online"],
    faqs: [
      { question: "Do I need to sign up to use this photo editor?", answer: "No. Drag a photo straight into the editor and start adjusting immediately — no account, no install, no upload to a server." },
  ...
  },
  {
    ...
    icon: Stamp,
    accent: "indigo",
    keywords: ["watermark image online free", "add watermark to photo", "text watermark", "image watermark tool", "add watermark to image free", "online watermark tool", "watermark photo free", "add watermark online"],
    faqs: [
      { question: "Is this watermark tool free?", answer: "Yes, completely free with no signup, no branding added by us, and no limit on how many photos you watermark." },
      { question: "Can I add both text and image watermarks?", answer: "Yes, switch between the Text Watermark and Image Watermark tabs depending on what you need." },
      { question: "Can I control watermark position?", answer: "Yes, a nine-point grid lets you anchor the watermark to any corner, edge, or the center of the photo." },
      { question: "What formats are supported?", answer: "JPG, PNG, and WebP." },
      { question: "Is my image uploaded to a server?", answer: "No, the watermark is rendered with the browser's Canvas API — your photo and logo never leave your device." },
      { question: "Can I adjust opacity?", answer: "Yes, use the opacity slider to make the watermark as subtle or as bold as you want." },
      { question: "Can I use my own logo as a watermark?", answer: "Yes, upload any PNG, JPG, or WebP logo in the Image Watermark tab and scale it as a percentage of the photo's width." },
      { question: "Will the watermark reduce my photo's quality?", answer: "No, only the watermark layer is added — the underlying photo resolution and quality are preserved." },
    ],
  ...
  },
  {
    ...
    icon: ScanEye,
    accent: "cyan",
    keywords: ["image metadata viewer", "EXIF data viewer", "view image metadata online", "EXIF reader free", "exif data viewer", "view photo metadata", "check image exif online", "remove exif data from photo"],
    faqs: [
      { question: "What metadata can I view?", answer: "Camera make and model, lens, date taken, exposure time, aperture, ISO, GPS coordinates, dimensions, and color space." },
      { question: "What formats are supported?", answer: "JPG, PNG, WebP, and HEIC." },
      { question: "Can I see GPS location?", answer: "Yes, if the image contains GPS EXIF data — click \"View on Google Maps\" to see exactly where it was taken." },
      { question: "Is my image uploaded to a server?", answer: "No, metadata is read entirely in your browser with JavaScript — nothing is ever sent anywhere." },
      { question: "Can I export the metadata?", answer: "Yes, click \"Copy all metadata as JSON\" to export every detected field at once." },
      { question: "Does this tool remove or strip EXIF data from my photo?", answer: "No, this tool only reads and displays metadata — it doesn't modify or download a stripped copy. To remove EXIF data, re-save the image through most editors or messaging apps, which strip it automatically." },
      { question: "Why does my photo show no metadata?", answer: "Many social platforms, messaging apps, and screenshot tools strip EXIF data automatically before you download or share the image, which is why plenty of photos will show an empty result here." },
      { question: "Is it free to use?", answer: "Yes, completely free with no signup and no limit on how many images you check." },
    ],
  ...
  },
  {
    ...
    icon: Braces,
    accent: "pink",
    keywords: ["image to base64", "base64 to image", "encode image base64 online free", "base64 converter", "base64 encode image", "convert image to base64", "png to base64", "jpg to base64", "svg to base64", "image to base64 converter"],
    faqs: [
      { question: "Is this image to Base64 converter free?", answer: "Yes, it's 100% free with no signup, no watermark, and no limit on how many images you convert." },
      { question: "Does it upload my image to a server?", answer: "No. Encoding and decoding both happen locally in your browser using the FileReader API — your image never leaves your device." },
      { question: "What image formats are supported?", answer: "PNG, JPG, WebP, GIF, and SVG are all supported for both encoding and decoding." },
      { question: "How do I use the Base64 string in HTML?", answer: `Paste the generated data URL directly into an <img> tag's src attribute, e.g. <img src="data:image/png;base64,...">, with no separate image file needed.` },
      { question: "How do I use Base64 in CSS?", answer: `Use the data URL as a background-image value, e.g. background-image: url("data:image/png;base64,...") — useful for small icons or sprites you want bundled into your stylesheet.` },
      { question: "What is Base64 encoding?", answer: "Base64 is a text encoding scheme that represents binary data — like an image file — as a string of letters, numbers, and a few symbols, so it can be embedded anywhere plain text is allowed, such as HTML, CSS, or JSON." },
      { question: "Why is my Base64 string so long?", answer: "Base64 encoding increases file size by roughly 33% compared to the original binary, since every 3 bytes of image data becomes 4 characters of text. Larger or high-resolution images produce proportionally longer strings." },
      { question: "Can I convert SVG to Base64?", answer: "Yes, SVG files encode the same way as raster images — upload the .svg file and copy the resulting data URL." },
      { question: "Is there a file size limit?", answer: "You can encode images up to 20MB. Keep in mind very large Base64 strings are impractical to embed inline in HTML or CSS." },
      { question: "How do I decode Base64 back to an image?", answer: "Switch to the Base64 to Image tab, paste a full data URL or a raw Base64 string, preview the result, then click Download image to save it as a file." },
    ],
