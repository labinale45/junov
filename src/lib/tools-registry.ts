...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    icon: Layers,
    accent: "emerald",
    keywords: ["image compressor", "compress image online", "reduce image size", "jpg compressor", "png compressor free", "compress a image", "compress picture", "compression picture", "compression photo", "photo compressor online"],
    faqs: [
