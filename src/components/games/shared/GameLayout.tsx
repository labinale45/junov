        ...
        <div className="mb-3 flex flex-wrap items-center justify-between gap-3 animate-in fade-in-0 duration-500">
          <div className="flex items-center gap-3">
            ...
            <nav aria-label="Breadcrumb" className="hidden items-center gap-1.5 text-sm text-slate-500 sm:flex">
              ...
              <Link href="/games" className="rounded-md px-1.5 py-0.5 transition-colors hover:bg-white/5 hover:text-slate-300">
                Games
              </Link>
              <ChevronRight className="h-3.5 w-3.5 text-slate-700" aria-hidden />
              <span className="rounded-md px-1.5 py-0.5 text-slate-300">{game?.name ?? "Game"}</span>
            </nav>
          </div>
          <CopyLinkButton />
        </div>
